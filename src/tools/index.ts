...
export function setupTools(server: McpServer, context: MCPContext): void {
  ...
  server.registerTool(
    ...
    {
      title: "Get all category paths in a team",
      description:
        "Retrieves all category paths in a team at once (no pagination). Returns a simple list of paths with post counts, sorted in lexicographic order. Supports filtering by prefix, suffix, match, or exact_match parameters.",
